...
export default function Modal({open, onClose, didWin, city, cur, handlePlayAgain, handleSetMode, handleHome}) {
    ...
    return ReactDOM.createPortal(
        <>
            ...
            <div className='modalflex' style={MODAL_STYLES}>
                ...
                <div className='text'>or...</div>
                <div><button className='homebutton' onClick={handleHome}>Return Home</button></div>
            </div>
        </>,
